...
#对应节点
# nodes = [1,2,3,5,6,8,9,10,12,13,14,16,17,18,20]
nodes = [1,2,3,5,6,8,9,10,12,13,14,16,17,18,20,4,7,15,11,19]
for file in files:
	print(file)
	# pdb.set_trace()
	data = sio.loadmat(os.path.join(data_path,file))['d_skel']
	# pdb.set_trace()
