...
To that end, the developed construction motion library contains Construction Motion Data Library(CML) contains 137 types of activities and 6131 samples(ALL_DATA); among them, 53 types of activities and 4333 samples are highly related to construction activities ( Construction_Related_Data). 

Downlaod dataset DOI: https://doi.org/10.6084/m9.figshare.20480787.v1. 

Meanwhile, we provides full codes in this repository, which could be used to align different skeleton data from 16 public 3D skeleton datasets.
